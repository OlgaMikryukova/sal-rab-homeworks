...
function renderProductsCards(json) {
    ...
    clearProducts();
    let clearProducts = parseProducts(json); // Помоему тут ошибка в задании, должен быть не clearProducts, а просто products
...
// Выполните функцию parseProducts, передав в неё json - аргумент функции и запишите результат в переменную clearProducts
